      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-[#111527] border border-white/5 rounded-2xl p-8">
          ...
          {selectedRole === 'student' && (
            <div className="mb-4">
              ...
              <div className="mt-2 min-h-[40px]">
                {geocoding && (
                  <div className="flex items-center gap-2 text-xs text-[#7b82a8]">
                ...
                {!geocoding && collegePreview && (
                  <div className="flex items-start gap-2 bg-accent-green/10 border border-accent-green/30 rounded-lg px-3 py-2">
                    ...
                    <div>
                      <div className="text-accent-green text-xs font-semibold">College located!</div>
                      <div className="text-[#7b82a8] text-xs mt-0.5 line-clamp-2">{collegePreview.name}</div>
                    </div>
                  </div>
                )}
                {!geocoding && geocodeError && college.length >= 5 && (
                  <div className="flex items-center gap-2 bg-red-500/10 border border-red-500/30 rounded-lg px-3 py-2">
                    ...
                    <div className="text-red-400 text-xs">
                      Couldn't find this college. Try the full name, e.g. "Visvesvaraya National Institute of Technology Nagpur"
                    </div>
                  </div>
                )}
              </div>
          ...
          <button
            ...
            disabled={loading || !selectedRole || (selectedRole === 'student' && (!college || geocoding || !collegePreview))}
          ...
          {selectedRole === 'student' && college && !collegePreview && !geocoding && (
